...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900&display=swap" rel="stylesheet" />
                ...
                <?php foreach ($res as $row) { ?>
                    <div class="productDetails container">
                        <div class="productImg">
                            <img src="./image/<?php echo $row['images']; ?>" alt="Product Image" />
                        </div>
                        <div class="productInfos">
                            ...
                            <button type="button" onclick="window.location.href='Updatedcheckout.php?id=<?php echo $row['id']; ?>'">
                                Buy Now
                            </button>
                        </div>
                    </div>
